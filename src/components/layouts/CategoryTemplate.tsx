      ...
      return (
        <>
          <div
            ...
            className="images"
          >
            <a href="#"><img src={b?.img?.url} /></a>
            <div style={{ textAlign: "center" }}>
              <a href="#"><p style={{ fontWeight: "bold" }}>{b?.productName}</p> </a>
              <a href="#"><p>{b?.brandName}</p></a>
              <a href="#"><p>
                {" "}
                {StaticData.Dollar}
                {b?.price}
      ...
      return (
        <>
          <div
            ...
            className="images"
          >
            <a href="#"><img src={ac?.img?.url} /></a>
            <div style={{ textAlign: "center" }}>
              <a href="#"><p style={{ fontWeight: "bold" }}>{ac?.productName}</p> </a>
              <a href="#"><p>{ac?.brandName}</p></a>
              <a href="#"><p>
                {" "}
                {StaticData.Dollar}
                {ac?.price}
